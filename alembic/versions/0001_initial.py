...
def upgrade() -> None:
    ...
    op.create_table('api_source_health',
    ...
    op.create_table('draw_corrections',
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('pending_comparisons',
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('draw_result_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_pending_comparisons_draw_result_id'), 'pending_comparisons', ['draw_result_id'], unique=False)
